...
export function CrmCitationChip({ citation, onOpen }: { citation: CrmCitation; onOpen: () => void }) {
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-lg border border-six-orange/30 bg-six-orange/10 px-2.5 py-1.5 text-xs text-amber-100 transition-colors hover:border-six-orange/60 hover:bg-six-orange/20"
    >
      <FileText className="h-3.5 w-3.5 shrink-0 text-six-orange" />
